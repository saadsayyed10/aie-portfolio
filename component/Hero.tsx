    ...
    <div className="flex justify-start items-start w-full flex-col lg:gap-y-2 lg:mb-10 lg:mt-24">
      ...
      <div className="flex justify-start items-start w-full lg:gap-x-4 lg:mt-4">
        <button
          ...
          className="border-green-500 border-2 text-black rounded-md font-semibold cursor-pointer bg-green-500 hover:bg-green-500/80 hover:border-green-500/80 transition duration-300 lg:px-6 lg:py-2"
        >
          View My Work
        </button>
        <button
          ...
          className="border-green-500 border-2 text-white rounded-md font-semibold cursor-pointer hover:bg-green-500/40 transition duration-300 lg:px-6 lg:py-2"
        >
          Contact Me
        </button>
      </div>
